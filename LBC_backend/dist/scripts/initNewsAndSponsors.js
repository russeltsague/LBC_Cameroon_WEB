...
async function initializeNewsAndSponsors() {
    try {
        ...
        await Sponsor_1.default.deleteMany({});
        // Insert sample news
        console.log('Inserting sample news...');
        const createdNews = await News_1.default.insertMany(sampleNews);
        console.log(`Created ${createdNews.length} news articles`);
        // Insert sample sponsors
        console.log('Inserting sample sponsors...');
        const createdSponsors = await Sponsor_1.default.insertMany(sampleSponsors);
...
exports.default = initializeNewsAndSponsors;
